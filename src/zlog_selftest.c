...
#ifdef ZLOG_BUILD_DRAFT_API
    { "private_classes", zlog_private_selftest },
#endif // ZLOG_BUILD_DRAFT_API
    {0, 0}          //  Sentinel
};
...
{
    test_item_t *item;
    printf ("Running zlogger selftests...\n");
    for (item = all_tests; item->test; item++)
        item->test (verbose);
